...
Declare Function MT_Get_PLC_Task_Count Lib "MT_API.dll" (ByVal ADev As Long, ByRef pValue As Long) As Long

Declare Function MT_Get_PLC_Task_Status Lib "MT_API.dll" (ByVal ADev As Long, ByVal AObj As Integer, ByRef pValue As Long) As Long

Declare Function MT_Get_PLC_Var_Seg Lib "MT_API.dll" (ByVal ADev As Long, ByRef pValue As Long) As Long

Declare Function MT_Get_PLC_Var_Used Lib "MT_API.dll" (ByVal ADev As Long, ByRef pValue As Long) As Long

Declare Function MT_Get_PLC_Status Lib "MT_API.dll" (ByVal ADev As Long, ByRef pValue As Long) As Long

Declare Function MT_Get_PLC_Tasks_Status Lib "MT_API.dll" (ByVal ADev As Long, ByRef pValue As Long) As Long

Declare Function MT_Get_PLC_Axis_Ratio Lib "MT_API.dll" (ByVal ADev As Long, ByVal AObj As Integer, ByRef pValue As Single) As Long

Declare Function MT_Get_PLC_Encoder_Ratio Lib "MT_API.dll" (ByVal ADev As Long, ByVal AObj As Integer, ByRef pValue As Single) As Long
