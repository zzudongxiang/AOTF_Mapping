...
MT_API INT32 __stdcall MT_Open_UART_Unicode(TCHAR* sCOM);
...
MT_API INT32 __stdcall MT_Get_System_Mem_Len(INT32* pValue);

MT_API INT32 __stdcall MT_Get_System_Mem_Data(WORD AObj,BYTE* pValue);

MT_API INT32 __stdcall MT_Set_System_Mem_Data(WORD AObj,BYTE Value);

MT_API INT32 __stdcall MT_Get_Optic_In_Num(INT32* pValue);

MT_API INT32 __stdcall MT_Get_Optic_In_Basic_Num(INT32* pValue);
...
MT_API INT32 __stdcall MT_Get_Optic_Out_Single(WORD AObj,INT32* pValue);

MT_API INT32 __stdcall MT_Get_Optic_Out_All(INT32* pValue);
...
MT_API INT32 __stdcall MT_Get_OC_Out_Single(WORD AObj,INT32* pValue);

MT_API INT32 __stdcall MT_Get_OC_Out_All(INT32* pValue);
...
MT_API INT32 __stdcall MT_Set_Axis_Mode_Home_Home_Zero(WORD AObj);
...
MT_API INT32 __stdcall MT_Get_PLC_Task_Count(INT32* pValue);

MT_API INT32 __stdcall MT_Get_PLC_Task_Status(WORD AObj,INT32* pValue);

MT_API INT32 __stdcall MT_Get_PLC_Var_Seg(INT32* pValue);

MT_API INT32 __stdcall MT_Get_PLC_Var_Used(INT32* pValue);

MT_API INT32 __stdcall MT_Get_PLC_Status(INT32* pValue);

MT_API INT32 __stdcall MT_Get_PLC_Tasks_Status(INT32* pValue);

MT_API INT32 __stdcall MT_Get_PLC_Axis_Ratio(WORD AObj,float* pValue);

MT_API INT32 __stdcall MT_Get_PLC_Encoder_Ratio(WORD AObj,float* pValue);
...
MT_API INT32 __stdcall MT_Set_Stream_Wait_Optic_In(WORD AObj,INT32 Value);

MT_API INT32 __stdcall MT_Set_Stream_Run_Check(void);
